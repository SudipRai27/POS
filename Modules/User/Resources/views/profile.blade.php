                    ...
                    <div class="panel-body table-responsive">
                        <div class="row">
                            <div class="col-md-3 col-lg-3 ">
                                @if($user->photo)
                                <img class="img-circle "
                                     src="{{URL::to('public/images/user_photos', $user->photo)}}"
                            ...
                            <div class=" col-md-9 col-lg-9 ">
                                ...
                                <table class="table table-user-information">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{date('Y M d D', strtotime($user->created_at))}}</td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td>{{$user->email}}</td>
						    ...
						    <div class="modal-dialog modal-lg">
						      <div class="modal-content">
						        ...
						        <div class="modal-body" >
						          ...
						          <input type="submit" name="Change Password" id="change-password" class="btn btn-success">
						          {{csrf_field()}}
						          </form>
